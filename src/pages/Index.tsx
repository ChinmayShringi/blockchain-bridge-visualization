  ...
  return (
    <PageTransition>
      <div className="min-h-screen relative">
        {/* Move Globe to be a full-page background */}
        <div className="fixed inset-0 z-0">
          <Globe />
        </div>

        {/* Main content wrapper with a subtle gradient background */}
        <div className="relative z-10">
          {/* Hero Section */}
          <section className="relative h-screen overflow-hidden flex items-center">
            {/* Gradient overlay for hero - slightly transparent */}
            <div className="absolute inset-0 bg-gradient-to-b from-nyu-dark/80 via-nyu-dark/70 to-transparent z-10"></div>
          ...
          {/* Events Section - More transparent background */}
          <section className="py-20 relative">
            <div className="absolute inset-0 bg-nyu-dark/70 backdrop-blur-sm"></div>
          ...
          {/* Mission Highlight Section - More transparent background */}
          ...
          {/* Newsletter Section - More transparent background */}
          <section className="py-20 relative">
            <div className="absolute inset-0 bg-nyu-dark/60 backdrop-blur-sm"></div>
            <div className="container mx-auto px-4 relative z-10">
          ...
          {/* Mission Cards - More transparent background */}
          <div className="grid md:grid-cols-3 gap-8 mt-12 px-4 md:px-8 pb-20 relative">
            {/* Background for cards section */}
            <div className="absolute inset-0 bg-nyu-dark/50 backdrop-blur-sm"></div>
            
            {/* Updated mission cards with glass effect */}
            <div className="relative z-10 bg-white/5 backdrop-blur-md p-8 rounded-lg border border-white/10 hover:bg-white/10 transition-colors">
